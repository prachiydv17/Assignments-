...
My_list.append(16) # Add element at the end
print("After adding 16 :", My_list)

My_list.insert(2,20) # Insert element at index 2
print("After inserting 25 at index 2 :", My_list)

My_list.remove(13) # Remove element by value
print("After removing 13:", My_list)
